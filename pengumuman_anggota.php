...
<body style="background-color: lightblue">
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Pengumuman</h1>
        ...
        <li>
            <div class="search" style="margin-top: 30px; margin-left:650px;">      
                <form method="GET" action="pengumuman.php">
                    <input  style="width:360px; height:50px; border-radius:10px;" type="text" name="cari" class="textbox" placeholder="   Masukkan id/judul pengumuman" onfocus="this.value = '';" 
                        onblur="if(this.value == '') {
                            this.value = ' Cari pengumuman';
                        }">&nbsp;
    ...
    <?php
        ...
        $jumlah_record = mysqli_query($koneksi, "SELECT * from pengumuman WHERE id_pengumuman = $id_pengumuman");
    ...
    <ul class="tp-hd-lft wow fadeInDown animated" data-wow-delay="0.5s" style="color:black;">
     <div class="content_box">
        <div class="container" style="background-color: lightblue;margin-top: 10px">
		    <div class="content_top" style="margin-top: 20px; background-color: white; " >
              ...
              <?php 
                if(isset($_GET['cari'])){
        				echo '<div> <p style="color="red">Berikut hasil pencarian pengumuman dengan keyword "'. $_GET['cari'] .'". </p></div>';
		    	    		$cari=mysqli_real_escape_string($koneksi, $_GET['cari']);
    			    		$pengumuman=mysqli_query($koneksi, "SELECT * FROM pengumuman WHERE id_pengumuman LIKE '%$cari%' or judul like '%$cari%'");
	            				if(mysqli_num_rows($pengumuman) == null){
				            		echo "<script>alert('Pengumuman $cari tidak ada, silahkan cari lainnya..') ;window.location = 'pengumuman.php'</script>";
                    }
                }
                else{
                        ...
                        while($p = mysqli_fetch_array($pengumuman)){ ?>	
                          <div class="grids_of_6"><br>
                            <div class="col-md-12">
                              <div class="col-md 7">
                                  <div class="content_box"><input type="hidden" value="<?php echo $p['id_pengumuman']?>">
                                  <div class="view view-fifth">
                                      <div style="color:black;float:right;"> Dipost tanggal <?php echo $p['waktu']; ?></div>
                                      <div class="mask1">
                                          <div class="info"> </div>
                                      </div>
                                  </div>
                                  </a>
                                  <h5 style="margin-left: -20px;"><?= $p['judul']?></a></h5>
                                  <div class="size_1">
                                      <span class="item_price"><?=($p['deskripsi'])?></span>
        ...
        <br><br>
          <ul class="pagination container a">
            <?php 
