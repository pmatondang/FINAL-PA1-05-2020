        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form action="cari_pemesanan.php" class="input-group col-md-4 col-md-offset-8" style="float:right;">
              ...
              <?php 
                if(isset($_GET['cari'])){
                  echo '<div> <b>Berikut hasil pencarian "'. $_GET['cari'] .'"</b></div><br/>';
                  $cari=mysqli_real_escape_string($koneksi, $_GET['cari']);
                  $pesanan=mysqli_query($koneksi, "SELECT * FROM pemesanan WHERE id_pemesanan LIKE '%$cari%' OR nama_lengkap LIKE '%$cari%'");
                }else{
                  $pesanan=mysqli_query($koneksi, "SELECT * FROM pemesanan ORDER BY id_pemesanan DESC LIMIT $start, $per_hal");
                  ...
                  <table class="table table-bordered" style="color:black" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $b['tgl_pinjam'] ?> sampai <?php echo $b['tgl_kembali'] ?></td>
                        <td>
                          <a href="detail_pemesanan.php?id=<?php echo $b['id_pemesanan']; ?>" class="btn btn-info">
                            <span class="fas fa-search fa-sm"></span></a>
                          <a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ 
                            location.href='hapus_pemesanan.php?id=<?php echo $b['id_pemesanan']; ?>' }" class="btn btn-danger">
                            <span class="fas fa-trash fa-sm"></span></a>
                          <a href="pesan_email.php?id=<?php echo $b['id_pemesanan']; ?>" class="btn btn-info">
                          <span class="fas fa-reply fa-sm"></span></a>
                        </td>
                      </tr>
                    </tbody>
                    <?php }?>
                ...
                <ul class="pagination a" style="margin-left:740px;">
                  <?php 
                    if($page == 1){ // Jika page adalah page ke 1, maka disable link PREV
                        ...
                        ?>
                          <li class="page-item"><a class="page-link" href="pemesanan.php?page=1">First</a></li>
                          <li class="page-item"><a class="page-link" href="pemesanan.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                        <?php
                        }
                    for($x = 1;$x <= $halaman; $x++){?>
                      <li class="page-item" ><a class="page-link" href="?page=<?php echo $x?>"><?php echo $x ?></a></li>
                        ...
                        ?>
                            <li class="page-item"><a class="page-link" href="pemesanan.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li class="page-item"><a class="page-link" href="pemesanan.php?page=<?php echo $halaman; ?>">Last</a></li>    
                        <?php }
                        ?>
                    </li>
                </ul>
