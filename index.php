        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-7 text-center text-lg-left" id="intro-section">
              ...
              <a data-aos="fade-right" href="#login_form" id="login_pop" class="btn btn-outline-white">Mendaftar menjadi anggota</a>
            </div>
            <!-- popup form #1 -->
              <a href="#x" class="overlay" id="login_form"></a>
              <div class="popup">
                <b><center><h4>Silakan bergabung dengan kami</h4>
                <p style="color:black;">Mari isi data anda</p></center></b>
                <form method="POST" action="registrasi_anggota_proses.php">
                    <fieldset id="inputs" style="color: black;">
                        ...
                        <div class="input-group">Jenis Kelamin</div>
                        <div>
                        ...
                        <div class="input-group">Motivasi</div>
                        <div>
                            <span class="glyphicon glyphicon-lock span"></span>
                              <textarea rows="3" type="text" id="input_reg" class="input" name="motivasi" placeholder="berikan motivasi anda" required></textarea><br>
                              <center><input type="submit" class="submit_daftar" name="submit_anggota" value="DAFTAR"></center>
                        </div>
                    </fieldset>
                </form>
 ...
 <!-- <div class="container" style="background-color: rgb(159, 223, 243)"> -->
        ...
        <div>
          <div class="feature-1 text-center">
            <p data-aos="fade-down" data-aos-delay="200" data-aos-offset="-500"><br>
              <a href="pengumuman.php" class="btn btn-outline-white" style="color:black;">Lebih Banyak Pengumuman</a>
            </p>
          </div>
        </div><br>
      </div>
  ...
  <div class="col-md-12" style="background-color: lightblue">
    <section class="section">
      ...
      <p><center><a href="produk.php" class="btn btn-primary">Semua Produk</a></center></p>
    </section>
      ...
      <section class="section border-top border-bottom" style="background-color: #F8F8FF;">
        ...
        <div class="container">
          ...
          <div class="feature-1 text-center" >
            <p data-aos="fade-down" data-aos-delay="200" data-aos-offset="-500"><br>
              <a href="about_us.php" style="background-color: blue;" class="btn btn-outline-white">Tambahkan Jawabanmu Sekarang</a>
            </p><br>
        </div>
